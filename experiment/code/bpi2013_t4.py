...
def trainandtest(train_loader, test_loader, cnn, loss_func, lrc, train_dataset, epochs, device):
    ...
    # 保存模型
    torch.save(model.state_dict(), f'train_bpi2013_t2025_10_7_{lrc}.pth')
...
if __name__ == '__main__':
    ...
    acclist31.append(trainandtest(train_loader1, test_loader1, CNN_Net3, loss_func, 0.003, train_dataset1, 100,device))
    # acclist31.append(trainandtest(train_loader2, test_loader3, CNN_Net2, loss_func, 0.003, train_dataset1, 100,device))
    # acclist31.append(trainandtest(train_loader3, test_loader2, CNN_Net1, loss_func, 0.003, train_dataset1, 100,device))
    print(acclist31)
    end_time=time()
